...
```{r DepthRugDensPlot, warning = FALSE, fig.width = 7.5, fig.height = 7, fig.cap="Density of all fish by depth. Shape indicates the MPA of the site, and color indicates whether the site was inside or outside the MPA. Lines fit using LOESS smoothing."}
