...
```{r allDens, fig.width = 7.5, fig.height = 7, fig.cap="Total fish density at sites by rugosity. Shape indicates the MPA of the site, and color indicates whether the site was inside or outside the MPA."}
