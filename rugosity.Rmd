...
rugsum <- rug %>%
     ...
     mutate(Zm_pos = - Zm)
t.test(filter(rugsum,MPA=="MCD")$meanrug, filter(rugsum,MPA=="MSR")$meanrug, 
...
```{r lionDensRug, fig.width = 7.5, fig.height = 7, fig.cap="Lionfish density at sites by rugosity of site. Shape indicates the MPA in which the site was located, and color indicates whether the site was inside or outside the MPA."}
...
```{r lionBioRug, fig.width = 7.5, fig.height = 7, fig.cap="Lionfish biomass at sites by rugosity of site. Shape indicates the MPA in which the site was located, and color indicates whether the site was inside or outside the MPA."}
...
```{r allDens, fig.width = 7.5, fig.height = 7, fig.cap="Total fish density (#/100m2) of sites by rugosity (cm). Shape indicates the MPA of the site, and color indicates whether the site was inside or outside the MPA."}
